...
import userdeposit from "../../../models/deposit";
...
const depositServices = {
    userCheck: async (userId) => {
        ...
        return await userdeposit.findOne(query);
    },
    ...
    checkSocialLogin: async (socialId, socialType) => {
        return await userdeposit.findOne({ socialId: socialId, socialType: socialType });
    },

    createUserdepost: async (insertObj) => {
        return await userdeposit.create(insertObj);
    },

    findUser: async (query) => {
        return await userdeposit.findOne(query).select('-otp');
    },
    ...
    deleteUser: async (query) => {
        return await userdeposit.deleteOne(query);
    },

    userFindList: async (query) => {
        return await userdeposit.find(query);
    },

    updateUser: async (query, updateObj) => {
        return await userdeposit.findOneAndUpdate(query, updateObj, { new: true }).select('-otp');
    },

    updateUserById: async (query, updateObj) => {
        return await userdeposit.findByIdAndUpdate(query, updateObj, { new: true }).select('-otp');
    },

    insertManyUser: async (obj) => {
        return await userdeposit.insertMany(obj);
    },
    ...
    paginateSearch: async (validatedBody) => {
        ...
        return await userdeposit.paginate(query, options);
    },
